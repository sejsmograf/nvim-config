...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>f", builtin.git_files, { desc = "[S]earch git [F]files" })
...
-- Configure VimWiki files to be recognized as markdown
vim.api.nvim_create_autocmd("BufWinEnter", {
	pattern = "*.md",
	callback = function()
		print("vimwiki: setting syntax to markdown")
...
-- Check if system is MsWindows
if vim.fn.has("win32") then
	-- Use <C-c> for yank to systems clipboard
